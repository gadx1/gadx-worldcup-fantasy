    ...
    <article className="rounded-3xl border border-slate-900/10 bg-white/80 p-6 shadow-sm">
      <div className="flex flex-col gap-3">
        ...
        <p className="max-w-4xl text-sm leading-6 text-slate-600">
          ...
          all setup and result management should happen from this admin view.
        </p>
      </div>
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-2">
        <section className="rounded-2xl border border-slate-900/10 bg-slate-50 p-5">
          ...
          <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm leading-6 text-slate-600">
            ...
            <li>Do not share the admin URL with players.</li>
          </ol>
        </section>
        ...
        <section className="rounded-2xl border border-slate-900/10 bg-slate-50 p-5">
          ...
          <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm leading-6 text-slate-600">
            <li>Use the Match Admin section from the admin view.</li>
      ...
      <div className="mt-5 rounded-2xl border border-amber-200 bg-amber-50 p-5">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-amber-900">
          ...
          <li>Player invitations are managed through Cloudflare Access, not inside the app.</li>
          <li>The public viewer is open, but admin writes should be further protected in a later version.</li>
        </ul>
      </div>
